...
<head>
    ...
    <title>Trang quản trị - Website đồ án EPHP</title>
    <!-- Bootstrap Core CSS -->
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="/thoat-admin.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="<?php echo isset($open) && $open == "slide" ? 'active' : '' ?>">
                        <a href="<?php echo modules("slide") ?>"><i class="fa fa-database"> Slide</i></a>
                    </li>
                    <li class="<?php echo isset($open) && $open == "transactions" ? 'active' : '' ?>">
                        <a href="<?php echo modules("transactions") ?>"><i class="fa fa-database">Đơn hàng</i></a>
                    </li>
