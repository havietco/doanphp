<?php
    ...
    $id = getInput('id');
    $cateName = $db->fetchId("category",$id);
    $sqlProduct = "SELECT product .* FROM product WHERE category_id = $id ";
            ...
            <div class="col product_section clearfix">
                ...
                <div class="breadcrumbs d-flex flex-row align-items-center">
                    <ul>
                        ...
                        <li class="active"><a href="/"><i class="fa fa-angle-right" aria-hidden="true"></i><?= $cateName['name'] ?></a></li>
                    </ul>
                </div>
